...
def parse_args():
    ...
    parser.add_argument('-m','--nostereo_database', type=str, help='The folder path for the database where the similes without stereoisomer information is stored', required=True, default='Molecular_database/deduplicate_nostereo')
    parser.add_argument('-ms','--deduplicated_database', type=str, help='The folder path for the deduplicated database with the stereo information', required=True, default='Molecular_database/deduplicate_canonical')
    ...
    parser.add_argument('-i', '--index_file', type=str, help='The index file generated by the nostereo database',  required=True)
