...
def parse_args():
    ...
    parser.add_argument('-k','--top_k', type=int, help='How many molecular to retrieve (it might return less because of the algorithm)', required=False, default=1000)
...
def main():
    ...
    search = {"similarity": partial(fp.similarity_search, top_k=top_k, threshold=threshold), "substructure": fp.substructure_screenout}    
