...
def parse_args():
    ...
    parser.add_argument('-o', '--on_disk', action='store_true', help='Whether to perform on disk operations',  required=False)
    ...
    return args.db_name, args.nostereo_database, args.index_file, args.top_k, args.threshold, args.num_workers, args.query_path, args.on_disk, args.hac_limits, args.mw_range, args.search_type, args.deduplicated_database, args.commercially_avaliable, args.commercial_databases, args.pairwise_database, args.cdb_id, args.stage
...
class FPSim2Query:
    ...
    def similarity_search(
        ...
        for que in self.queries:
            results = method(que, threshold=threshold, n_workers=self.workers)
...
def main():
    ...
    match stage:    
        case "search":
            process_query_by_db(db_name, query, num_workers, on_disk, threshold, search_type, outpath=outpath)
